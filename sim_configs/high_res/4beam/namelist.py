...
# YZ Plane Foil Front Surface
DiagProbe(
    # name = "my_probe",
    every=5 * data_sample_rate,
    origin=[microns_to_norm_units(8.5), 0., 0.],
    corners=[
        [microns_to_norm_units(8.5), Lsim[1], 0.],
        [microns_to_norm_units(8.5), 0., Lsim[2]],
    ],
    number=[1000, 1000],
    fields=["Ex", "Ey", "Ez", "Rho_hydrogen_ions", "Rho_hydrogen_electrons"]
)
...
DiagProbe(
    ...
    corners=[
        [microns_to_norm_units(20), Lsim[1], 0.],
        [microns_to_norm_units(20), 0., Lsim[2]],
    ],
    number=[1000, 1000],
